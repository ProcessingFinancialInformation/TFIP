    ...
    public class MapperProfile : Profile
    {
        ...
        private void ConfigureIndividualClient()
        {
            ...
            AutoMapper.Mapper.CreateMap<CreditRequest, CreditRequestListItemViewModel>()
                ...
                .ForMember(dest => dest.StatusId, source => source.MapFrom(x => x.Status))
                .ForMember(dest => dest.LastPaymentDate, source => source.MapFrom(x => mapperProfileService.GetLastPaymentDate(x.Payments)))
