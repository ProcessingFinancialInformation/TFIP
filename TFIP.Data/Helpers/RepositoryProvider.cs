...
namespace TFIP.Data.Helpers
{
    ...
    public class RepositoryProvider: IRepositoryProvider
    {
        ...
        public RepositoryProvider(RepositoryFactories repositoryFactories, DbContext context)
        {
        ...
        /// </remarks>
        public IBaseRepository<T> GetRepositoryForEntityType<T>() where T : class, IEntity
        {
